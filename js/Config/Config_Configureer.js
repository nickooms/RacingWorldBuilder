var cfgWin, tabActions, actionPanel, tabPanel;
...
function Conf_Configureer() {
  var resolutions = [];
  for (var i = 0; i < map.scales.length; i++) {
    resolutions.push(OpenLayers.Util.getResolutionFromScale(map.scales[i], map.units));
  }
  if (cfgWin) {
    cfgWin.show(this);
    return;
